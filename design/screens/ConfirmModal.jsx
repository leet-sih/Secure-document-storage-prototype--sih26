// DESIGN REFERENCE — match this layout exactly when building src/components/ConfirmModal.tsx
 ...
 *
 * Props:
 *   modalTitle        {string}   — e.g. "Delete document"
 *   modalBody         {string}   — explanatory text
 *   modalConfirmLabel {string}   — label for the destructive button, e.g. "Delete"
 *   onConfirm         {fn}
 *   onClose           {fn}
 */
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <span style={{ color: "#ef4444", display: "flex" }}><AlertTriangle size={18} /></span>
          <span style={{ fontSize: "17px", fontWeight: 600, color: "#e8eaf0" }}>{modalTitle}</span>
        </div>
